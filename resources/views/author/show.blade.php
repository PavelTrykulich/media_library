        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-3 ">
                    ...
                    @if(Auth::id() == $user->id)
                        <div class="btn-group card mb-3  " role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                <a class="dropdown-item" href="{{ Route('files.create','audio') }}">Audio</a>
                                <a class="dropdown-item" href="{{ Route('files.create','photo') }}">Photo</a>
                                <a class="dropdown-item" href="{{ Route('files.create','video') }}">Video</a>
                            </div>
                        </div>


                    <div class="card mb-3 box-shadow">
                        <a href="{{Route('author.edit',$user->id)}}" class="btn btn-secondary btn-lg " role="button" >Update profile</a>
                    </div>
                    @endif
                </div>
