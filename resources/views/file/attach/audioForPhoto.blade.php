...
@section('content')
    <form action="{{Route('attach.audioForPhoto',$id)}}" method="post">
        @method('put')
        @csrf
                            ...
                            <div class="card-body">
                                ...
                                <small class="text-muted">
                                    ...
                                    <div class="custom-control custom-checkbox align-items-md-center">
                                        ...
                                        <input  type="checkbox" class="custom-control-input" id="{{$file->title }}" name='filesId[]' value="{{$file->audio->id}}"
                                                {{in_array($file->audio->id,$checked) ? 'checked' : ''}}>
