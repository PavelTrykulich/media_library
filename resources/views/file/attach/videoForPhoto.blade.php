...
@section('content')
    <form action="{{Route('attach.videoForPhoto',$id)}}" method="post">
        @method('put')
        @csrf
                            ...
                            <div class="card mb-4 box-shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="custom-control custom-checkbox align-items-md-center">
                                        ...
                                        <input  type="checkbox" class="custom-control-input" id="{{$file->title }}" name='filesId[]' value="{{$file->video->id}}"
                                                {{in_array($file->video->id,$checked) ? 'checked' : ''}}>
